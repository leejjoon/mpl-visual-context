...
def plot_gradient():
    ...
    ib = ImageBox("up", alpha="left",
                  extent=(0, 0, 1, 1),
                  coords="data")
    axs[0].add_artist(ib)

    z = np.arange(100).reshape((10, 10))
    ib = ImageBox(z, alpha="left",
                  extent=(0, 0, 1, 1),
                  coords="data")
    axs[1].add_artist(ib)
    ...
    ib = ColorBox("r", alpha="up", shape=(10, 10),
                  extent=(0, 0, 1, 1),
                  coords="data")
    axs[3].add_artist(ib)
...
def plot_extent():
    fig, axs_ = plt.subplots(2, 2, num=2, clear=True,
                             layout="constrained")
    axs = axs_.flat
    ...
    ax = axs[2]
    a = ax.annotate("Matplotlib", (0.5, 0.5), va="center", ha="center",
                    fontsize=20)
    ib = ImageBox("right", alpha=0.4,
                  extent=(0, 0, 1, 1),
                  coords=a)
    ax.add_artist(ib)
